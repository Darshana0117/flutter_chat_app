...
class ChatPageState extends State<ChatPage> {
  ...
  List<Widget> generateSenderLayout(DocumentSnapshot documentSnapshot) {
    ...
    Timestamp t = documentSnapshot.data['time'];
    DateTime d = t.toDate();
    print(d.toString());
    return <Widget>[
      new Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: new Text(documentSnapshot.data['text'],style: TextStyle(fontSize: 16,),),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: new Text(d.toString(),style: TextStyle(fontSize: 10,color: Colors.grey),),
                    ),
                  ],
                ),
              ),
  ...
  List<Widget> generateReceiverLayout(DocumentSnapshot documentSnapshot) {
   // image=documentSnapshot.data['profile_photo'];
                  ...
                  : Container(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: new Text(d.toString(),style: TextStyle(fontSize: 10
